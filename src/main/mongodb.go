...
func main() {
	// Establezca el URI de conexión de MongoDB, incluido el nombre de usuario, la contraseña y el nombre de la base de datos
	...
	http.HandleFunc("/persons", func(w http.ResponseWriter, r *http.Request) {
		// Establezca los encabezados necesarios para manejar las solicitudes de CORS
	...
	// Dejando esto por ahora, pero lo eliminaré más tarde.
...
func createPerson(w http.ResponseWriter, r *http.Request, client *mongo.Client) {
	...
	// Obtenga la colección MongoDB del cliente
	...
	// Establezca el código de estado de respuesta en 201 Creado y devuelva la ID de la persona recién creada
...
func deletePerson(w http.ResponseWriter, r *http.Request, client *mongo.Client) {
	...
	// Eliminar el documento de persona con el ID especificado
	...
	// Establezca el código de estado de respuesta en 204 Sin contenido para indicar una eliminación exitosa
